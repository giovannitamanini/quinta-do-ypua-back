...
INSERT IGNORE INTO acomodacao (id, tipo, valor_diaria, descricao_hospedes, descricao_camas, mais_informacoes, amenidades, condicoes)
VALUES (1,"Suíte com Cozinha", 300.00, "Acomoda: 3", "Camas: 1 Solteiro, 1 Casal",
...
"Ar condicionado, WiFi, TV, Cozinha, Toalhas", "Mínimo de noites: 2");

INSERT IGNORE INTO acomodacao (id, tipo, valor_diaria, descricao_hospedes, descricao_camas, mais_informacoes, amenidades, condicoes)
VALUES (2, "Chalé Família", 500.00, "Acomoda: 5", "Camas: 1 Solteiro, 2 Casal",
...
INSERT IGNORE INTO acomodacao (id, tipo, valor_diaria, descricao_hospedes, descricao_camas, mais_informacoes, amenidades, condicoes)
VALUES (3, "Cabana", 400.00, "Acomoda: 3", "Camas: 1 Solteiro, 1 Casal",
...
INSERT IGNORE INTO acomodacao (id, tipo, valor_diaria, descricao_hospedes, descricao_camas, mais_informacoes, amenidades, condicoes)
VALUES (4, "Bus", 425.00, "Acomoda: 2", "Camas: 1 Casal",
"Obs: Os valores exibidos no site estão sujeitos a constantes atualizações. Nos feriados e datas comemorativas o valor da diária também é diferenciado. Para mais detalhes entre em contato por telefone. Bus é a grande novidade da pousada. A seguir alguns detalhes que acompanham esta acomodação especial: Roupas de cama; Roupas de banho; Banheira de hidromassagem; Cozinha básica; Taças; Churrasqueira; Televisão; Soundbar Jbl Cinema; Cafeteira com cápsula; Rede de descanso; Área com vista para o mar; Deck externo com fogueira; Acompanha uma cesta de café da manhã; (Arraste a imagem de capa para o lado para ver mais fotos da acomodação)",
"Ar condicionado, WiFi, TV, Frigobar, Ducha, Banheira, Cozinha, Toalhas", "Mínimo de noites: 2");

INSERT IGNORE INTO acomodacao (id, tipo, valor_diaria, descricao_hospedes, mais_informacoes, amenidades, condicoes)
VALUES (5, "Estacionamento Para Overlands", 100.00, "Acomoda: 4",
"Obs: Os valores exibidos no site estão sujeitos a constantes atualizações. Para mais detalhes entre em contato por telefone. A pousada conta também com um espaço plano com vista para o mar, destinado a estacionamento de overlands, tendo disponível para uso ponto de água e luz. Possui também banheiro e churrasqueira para uso comum destes viajantes. (Arraste a imagem de capa para o lado para ver mais fotos da acomodação)",
"WiFi, Ducha", "Mínimo de noites: 2");
